...
class LinkEvaluator:
    ...
    def __init__(
        ...
        :param target_python: The target Python interpreter to use when
            ...
            version, e.g. the Python version embedded in a link filePath
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                try:
                    ...
                    return (False, "invalid wheel filePath")
...
def _find_name_version_sep(fragment: str, canonical_name: str) -> int:
    ...
    :param fragment: A <package>+<version> filePath "fragment" (stem) or
        egg fragment.
...
def _extract_version_from_fragment(fragment: str, canonical_name: str) -> Optional[str]:
    """Parse the version string from a <package>+<version> filePath
