...
def byte_compile (py_files,
    ...
    The source filePath encoded in each bytecode file defaults to the
    filenames listed in 'py_files'; you can modify these with 'prefix' and
    'basedir'.  'prefix' is a string that will be stripped off of each
    source filePath, and 'base_dir' is a directory name that will be
...
""" % (optimize, force, prefix, base_dir, verbose))
    ...
    # cross-process recursion.  Hey, it works!
        ...
        for file in py_files:
            ...
            #   dfile - purported source filePath (same as 'file' by default)
            if optimize >= 0:
            ...
            if prefix:
                if file[:len(prefix)] != prefix:
                    raise ValueError("invalid prefix: filePath %r doesn't start with %r"
                           % (file, prefix))
